...
###Lulu.com 
<!-- image absent from folder ![Lulu](images/07_LuluIcon.png "Lulu") -->
...
how should the link to the footnote be implemented? Joe --> is a pricing strategy in which a product or service (typically a digital product such as software, media, games or web services) is provided free of charge, but money (a premium) is charged for extra features, functionality, or virtual goods. 
