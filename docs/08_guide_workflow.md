...
- There is no 'standard recipe' for electronic artists' and designers' books. These books can be published in a wide variety of formats, even as plain-text files or **animated GIF**s. More conventional scenarios include publishing artists' blogs as ebooks. 
