...
Central in a hybrid publishing workflow, we recommend the us of the mark-up language Markdown. Markdown is not perfect, but it's is the most easy to work with and enables the creation of structured texts, thus allowing for hybrid publishing.
