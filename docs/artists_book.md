...
The common denominator of these books is that they defy easy categorization and genre characteristics. This makes it difficult to give standard recommendations for their design as electronic books. 

### Transfer from paper to electronic?

The more medium-specific an artist's book is, the less sense it makes to translate it 1:1 into an electronic book. Dieter Roth's sculptural book objects, for example, would change from book art in its own right to catalogues of book art when reproduced electronically. 

On the other hand, many contemporary artists, designers and media activists experimented with electronic publishing as a "poor" medium of social sharing rather than a "rich" visual and tactile medium:
...
In these examples, the focus is not on the book as a visual object, but on concepts and politics of its sharing and dissemination; in other words, artists' publishing as conceptual samizdat. In these cases, artists' books as 1:1 transfers from print to electronic can make sense.
...
- epub. Little difference with HTML for offline reading, but better publication meta data and better compatibility to e-book projects. Projects can very easily be made and provided in both formats.
